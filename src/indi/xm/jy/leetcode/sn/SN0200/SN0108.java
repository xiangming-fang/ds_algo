...
public class SN0108 {
    // BST是二叉搜索树
    public indi.xm.jy.leetcode.data_structure.TreeNode sortedArrayToBST(int[] nums) {
    ...
    public indi.xm.jy.leetcode.data_structure.TreeNode highBalance(int[] ints, int startIndex, int endIndex){
        ...
        indi.xm.jy.leetcode.data_structure.TreeNode treeNode = new TreeNode(ints[mid]);
