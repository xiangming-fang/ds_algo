...
public class SN0108 {
    // BST是二叉搜索树
    public indi.xm.ds_algo.leetcode.data_structure.TreeNode sortedArrayToBST(int[] nums) {
    ...
    public indi.xm.ds_algo.leetcode.data_structure.TreeNode highBalance(int[] ints, int startIndex, int endIndex){
        ...
        indi.xm.ds_algo.leetcode.data_structure.TreeNode treeNode = new TreeNode(ints[mid]);
